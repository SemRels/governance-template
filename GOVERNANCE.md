...
SemRels governance-template is an open source project governed by its maintainers and community contributors. It exists to distribute consistent governance, community health, and REUSE-compliance files across SemRels repositories.
