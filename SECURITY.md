...
Report security issues privately via **[GitHub Security Advisories](https://github.com/SemRels/governance-template/security/advisories/new)**.
...
This policy applies to all code, automation, and documentation maintained in SemRels governance-template.
